...
public enum Step
{
    ...
    HEADS("Retrieve note heads", new HeadsStep()),
    STEMS("Retrieve stems connected to heads & beams", new StemsStep()),
    ...
    MEASURES("Retrieve raw measures from groups of barlines", new MeasuresStep()),
